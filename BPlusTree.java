...
public class BPlusTree {
	 ...
	 * PartObject[] and returns the index of the first null entry found.
	 ...
	 */
	static public int linearNullSearch(PartObject[] partsList) {
	 ...
	 * value.
	 * @param dps: list of partsList pairs sorted by key within leaf node
	 * @param t: target key value of partsList pair being searched for
	...
	/**
	 * This is a specialized sorting method used upon lists of PartObjects
